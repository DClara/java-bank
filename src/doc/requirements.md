...
have the org.academiadecodigo.javabank.view reading the model, either directly or indirectly via the org.academiadecodigo.javabank.controller.
What can not happen is for the org.academiadecodigo.javabank.view to update the model directly. Model updates must always be done via the org.academiadecodigo.javabank.controller.
